...
class ButtonLetter2 extends StatefulWidget {
  const ButtonLetter2({super.key, required this.text});
  final String text;

  @override
  State<ButtonLetter2> createState() => _ButtonLetter2State();
}

class _ButtonLetter2State extends State<ButtonLetter2> {
  bool selected = false;
